...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
                        ...
                        <li class=" in">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle" style="color: aliceblue;background-color: black;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <img src="{{asset('/images/users/{Auth::user()->profile_pic}')}}" height="30px" width="30px" style="border-radius: 50%;border: 1px solid rgb(92, 92, 92);overflow: hidden;margin-right: 10px;"> {{ Auth::user()->name }}
                                </button>
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center"> 2021 © NepCrypt
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
